...
const About = () => {
    return (
        ...
        <div className="gpt3__about-feature">
          <Feature title="What is NEX?" text="NEX is the native token for NEXZONEX GLOBAL Exchange, we created NEX for the support for our Exchange and as a community token , Later on we will be adding more important utility to the NEX Token , with lowest supply and highest on demand overall we could all grow together and aim for the moon. lets join the crypto revolution through NEX" />
        </div>
        ...
        <div className="gpt3__about-container">
          ...
          <Feature title="Project" text="Our project Nexzonex Global Exchange is up and running. feel free to check that out." />
